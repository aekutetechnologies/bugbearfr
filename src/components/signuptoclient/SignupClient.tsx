...
const SignupClient = () => {
    ...
    return (
        <>
            <h1 className='text-3xl font-semibolt text-center'>Sign up to hire talent</h1>
            <div className='w-[70%] m-auto'>
                <div className='w-[55%] m-auto'>
                    ...
                    <div className=''>
                            ...
                            <input type={type} placeholder="Password" className='w-full border-2 border_input1 border-black rounded p-2 outline-none md:h-9 mt-3 mb-4' /><span className="relative top-4 right-10" onClick={handleToggle}>
            ...
            <div className='w-full text-center'>
                <Link to={pathstr}><button className=' px-11 bg-[#65a30d] py-2 rounded-full mt-10'>Create my account</button></Link>
            </div>
        </>
    )
}
