  ...
  return (
    <>
      <div className='fixed inset-0 bg-white bg-opacity-30 z-100 backdrop-blur-sm h-full flex justify-center item-center'>
        <div className='w-[25%] mt-52 shadow h-[230px] rounded-xl bg-black text-center'>
          ...
          <input type="text" className='w-full outline-none text-black border border-white rounded' placeholder='Email' />
          </div>
          <div className='w-[80%] m-auto mt-10'>
          <button className='w-full h-8 rounded-full h-11 text-white bg-yellow-400'><span className='py-1 px-4'>Submit</span></button>
          </div>
